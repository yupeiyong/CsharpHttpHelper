 ...
 class FluentHttpHelper
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FluentHttpHelper"/> class.
        /// </summary>
        /// <param name="url"></param>
        public FluentHttpHelper(Uri url)
        ...
        /// </summary>
        /// <param name="url"></param>
        public FluentHttpHelper(string url)
            : this(new Uri(url))
        {
        }
        ...
        public FluentHttpHelper(HttpWebRequestWrapper httpWebRequest)
        {
            _httpWebRequest = httpWebRequest;
        }
